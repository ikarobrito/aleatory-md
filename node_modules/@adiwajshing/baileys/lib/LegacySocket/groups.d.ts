...
declare const makeGroupsSocket: (config: LegacySocketConfig) => {
    ...
    downloadMediaMessage: (message: import("@adiwajshing/baileys/WAProto").proto.IWebMessageInfo, type?: "buffer" | "stream") => Promise<Buffer | import("stream").Readable>;
    updateMediaMessage: (message: import("@adiwajshing/baileys/WAProto").proto.IWebMessageInfo) => Promise<BinaryNode>;
    ...
    sendPresenceUpdate: (type: import("@adiwajshing/baileys/src/Types/Chat").WAPresence, jid: string) => Promise<string>;
    ...
    setQuery: (nodes: BinaryNode[], binaryTag?: import("@adiwajshing/baileys/src/Types/Legacy").WATag, tag?: string) => Promise<{
        status: number;
    }>;
    currentEpoch: () => number;
